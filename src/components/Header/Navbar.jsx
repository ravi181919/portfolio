        ...
        <div className="p-2 w-full h-12 relative flex justify-between items-center ">
          ...
          <div className="w-fit py-2 px-2">
            <ul className="w-full flex items-center lg:gap-20 gap-5 justify-center">
              <NavLink to="/home" className="LinkAnimation dark:after:bg-white font-medium cursor-pointer text-xs lg:text-sm">Home</NavLink>
              <NavLink to="/skills" className="LinkAnimation dark:after:bg-white font-medium cursor-pointer text-xs lg:text-sm">Skills</NavLink>
              <NavLink to="/projects" className="LinkAnimation dark:after:bg-white font-medium cursor-pointer text-xs lg:text-sm">Projects</NavLink>
              <NavLink to="/contact" className="LinkAnimation dark:after:bg-white font-medium cursor-pointer text-xs lg:text-sm">Contact</NavLink>
              <NavLink to="/linkedin" className="LinkAnimation dark:after:bg-white hidden lg:block font-medium cursor-pointer text-xs lg:text-sm">LinkedIn</NavLink>
            </ul>
          </div>
